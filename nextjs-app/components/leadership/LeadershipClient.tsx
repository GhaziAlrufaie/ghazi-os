    ...
    <div className="app" style={{ direction: 'rtl' }}>
      ...
      <div className="section" style={{ marginBottom: 20 }}>
        ...
        <section className="section">
          <div className="section-head">
            <div className="section-title-wrap">
              <div className="section-icon" style={{ background: 'var(--sunshine-light)', color: 'var(--sunshine-deep)' }}>✨</div>
              <div className="section-title">
                <div className="section-title-text">البراندات</div>
                <div className="section-subtitle">{brands.length} براند</div>
              </div>
            </div>
            <Link href="/brands" className="section-link">عرض الكل →</Link>
          </div>
        </section>
